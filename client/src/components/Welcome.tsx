...
const Input = ({ name, type, value, placeholder, handleChange }: InputProps) => (
  <input
    ...
    className="my-2 w-full  p-2 outline-none bg-transparent text-white text-sm white-glassmorphism !border-none !rounded-sm"
  />
)
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row  flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          <div className="p-3 justify-end items-center flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorpism">
